...
public class ExtendedSetTest {
	...
	public void testFluentStyle() throws Exception {
		...
		list.insert(1).insert(2, 2, 3).insert(4, 4, 4, 5, 5).insert(asSet(6, 7, 8)).delete(
				4, 5, 6, 7, 8).delete(110).add(3);
	...
	public void testUnion() throws Exception {
		FluentSet<String> xp = set("tdd", "planning", "refactoring");
		FluentSet<String> scrum = set("restrospective", "planning", "scrum of scrums");
		assertEquals(set("tdd", "planning", "refactoring", "restrospective",
				"scrum of scrums"), xp.union(scrum));
	}
	...
	public void testXor() throws Exception {
		FluentSet<String> xp = set("tdd", "planning", "refactoring");
		FluentSet<String> scrum = set("restrospective", "planning", "scrum of scrums");
		assertEquals(set("tdd", "refactoring", "restrospective", "scrum of scrums"),
				xp.xor(scrum));
	}
